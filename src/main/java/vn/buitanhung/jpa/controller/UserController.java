package vn.buitanhung.jpa.controller;
...
import vn.buitanhung.jpa.service.BlogService;
import vn.buitanhung.jpa.service.UserService;
...
public class UserController {
	...
	@ModelAttribute("blog")
	public Blog constructBlog(Blog blog){
		return new Blog();
	}
